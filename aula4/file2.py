...
with open("LIVRO-Doenças-do-Aparelho-Digestivos_teste.html", "r+", encoding="utf-8") as file1: #também podia ser .txt
    texto = file1.read()
...
for l in linhas:
    ...
    for p in re.findall(r"\b[\w-]+\b", palavras): #é melhor esta versão para apanhar palavras com hifen
        p = p.lower()
